...
| Aspect | Baseline | Mandatory Blocking |
|--------|----------|-------------|
...
- **Mandatory Blocking**: Executed all BLOCKING steps including Step 15, because the Iron Rules and BLOCKING constraint made it non-optional.
...
### Mandatory Blocking (Experimental Group)
...
**Mandatory Blocking Rate: 100% (3/3)**
...
2. **Mandatory Blocking Agent wrote feedback 3/3 times** — The combination of Iron Rules, MANDATORY keyword, BLOCKING label, and CHECKPOINT verification prevented skipping.

3. **Context length matters** — Both prompts had 15 steps. In the baseline, Step 15 was buried at the end with no structural emphasis. In Mandatory Blocking, it was structurally anchored with all-caps keywords.
